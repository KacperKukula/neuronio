<template>
    <div :class="'editModule'" class="flex flex-col p-6 gap-5">
        ...
        <!--EDITING COMPONENT-->
        <div :class="'component-view'" class="pa-4">
...
if (!props.module.data) {
    const modData = await import(`@/blocks/${props.module.type}/data/${props.module.type}.data.ts`)
...
const editingComp = computed(() => {
    ...
    return defineAsyncComponent(() =>
        import(`@/blocks/${props.module.type}/${props.module.type}.edit.vue`)
    )
})
